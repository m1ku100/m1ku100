                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="kategori">
                                        ...
                                        <option value="kereta_bayi">Kereta Bayi</option>
                                        <option value="sepatu">Sepatu</option>
                                        <option value="sling">Sling Bayi</option>
                                        <option value="mainan_bayi">Mainan Bayi</option>
                                        <option value="kasur">Kasur</option>
                                        <option value="baby_walker">Baby Walker</option>
                                        <option value="bathup">Bathup</option>
                                        <option value="kursi_bayi">Kursi Bayi</option>
