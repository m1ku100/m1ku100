                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" method="post"  action="edit.php">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Harga Barang (Rp) </label>

                                <div class="col-sm-9">
                                    <input required name="harga" type="text" id="form-field-1" placeholder="Username"
                                           class="col-xs-10 col-sm-5" value="<?php echo $row['harga'];?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input required name="stock" type="text" id="form-field-1" placeholder="Username"
                                           class="col-xs-10 col-sm-5" value="<?php echo $row['stock'];?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input required name="tgl_input" type="date" id="form-field-1" placeholder="Username"
                                           class="col-xs-10 col-sm-5" value="<?php echo $row['tgl_input'];?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="kategori">
                                        <option value="Pakaian" <?=$row['kategori']=='Pakaian' ? 'selected="selected"' : '';?>Pakaian</option>
                                        <option value="kereta_bayi" <?=$row['kategori']=='kereta_bayi' ? 'selected="selected"' : '';?>Kereta Bayi</option>
                                        <option value="sepatu" <?=$row['kategori']=='sepatu' ? 'selected="selected"' : '';?>Sepatu</option>
                                        <option value="sling" <?=$row['kategori']=='sling' ? 'selected="selected"' : '';?>Sling Bayi</option>
                                        <option value="mainan_bayi" <?=$row['kategori']=='mainan_bayi' ? 'selected="selected"' : '';?>Mainan Bayi</option>
                                        <option value="kasur" <?=$row['kategori']=='kasur' ? 'selected="selected"' : '';?>Kasur</option>
                                        <option value="baby_walker" <?=$row['karegori'] == 'baby_walker' ? ' selected="selected"' : '';?>Baby Walker</option>
                                        <option value="bathup" <?=$row['kategori']=='bathup' ? 'selected="selected"' : '';?>Bathup</option>
                                        <option value="kursi_bayi" <?=$row['kategori']=='kursi_bayi' ? 'selected="selected"' : '';?>Kursi Bayi</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input required name="gambar" type="file" id="form-field-1" placeholder="Username"
                                           class="col-xs-10 col-sm-5" value="<?php echo $row['gambar'];?>"/>
                                </div>
                            </div>
