...
$query = "insert into transaksi (penyewa,barang,tgl_sewa,tgl_kembali,lama_sewa,total_bayar,status)
values ('$_REQUEST[penyewa]','$_REQUEST[barang]','$_REQUEST[tgl_sewa]','$_REQUEST[tgl_kembali]','$_REQUEST[lama_sewa]','$_REQUEST[total_bayar]','$_REQUEST[status]')";
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" method="post" target="_self" action="form-elements.php">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input required name="no_identitas" type="text" id="form-field-1" placeholder="text"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input required name="penyewa" type="text" id="form-field-1" placeholder="penyewa"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input required name="Barang" type="text" id="form-field-1" placeholder="barang"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input required name="tgl_sewa" type="date" id="form-field-1" placeholder="tgl"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input required name="tgl_kembali" type="date" id="form-field-1" placeholder="tgl"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input required name="total_bayar" type="text" id="form-field-1" placeholder="username"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input required name="status" type="date" id="form-field-1" placeholder="status"
                                           class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
